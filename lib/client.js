...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".thm_weekHeadCell{color:var(--dsw-alias-label-caption);flex:1;min-width:0;font-size:9px;line-height:12px;text-align:center}",
			...
			".thm_legend{align-items:center;justify-content:flex-end;gap:3px;font-size:10px;line-height:14px;display:flex;color:var(--dsw-alias-label-tertiary)}",
